...
set ::env(VERILOG_FILES) "\
	../params.vh \
    $::env(DESIGN_DIR)/rtl/utils/commoncell/counter.v \
    $::env(DESIGN_DIR)/rtl/utils/commoncell/counter2.v \
    ...
    $::env(DESIGN_DIR)/rtl/lsuv1/arbiter_base.v \
    $::env(DESIGN_DIR)/rtl/lsuv1/lsu_agu.v \
    $::env(DESIGN_DIR)/rtl/lsuv1/lsu_bus_ctrl.v \
    $::env(DESIGN_DIR)/rtl/lsuv1/lsu_lsq_entry.v \
    $::env(DESIGN_DIR)/rtl/lsuv1/lsu_lsq.v \
    $::env(DESIGN_DIR)/rtl/lsuv1/lsu_mc.v \
    $::env(DESIGN_DIR)/rtl/lsuv1/lsu_pma_checker.v \
    $::env(DESIGN_DIR)/rtl/lsuv1/lsu_wb_arb.v \
    $::env(DESIGN_DIR)/rtl/lsuv1/lsuv1.v \
    $::env(DESIGN_DIR)/rtl/csr/csr.sv \
    $::env(DESIGN_DIR)/rtl/alu.v \
    $::env(DESIGN_DIR)/rtl/div.v \
    $::env(DESIGN_DIR)/rtl/mul.v \
    $::env(DESIGN_DIR)/rtl/md.v \
    $::env(DESIGN_DIR)/rtl/fu.v 
	"
