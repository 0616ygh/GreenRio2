...
set ::env(VERILOG_FILES) "\
    ...
    $::env(DESIGN_DIR)/rtl/rvc_decoder.v \
    $::env(DESIGN_DIR)/rtl/rv_decoder.v \
     $::env(DESIGN_DIR)/rtl/configurable_counter.v \
    $::env(DESIGN_DIR)/rtl/f2if2o.v \
    $::env(DESIGN_DIR)/rtl/decode.v
	"
